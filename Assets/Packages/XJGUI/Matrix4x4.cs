...
namespace XJGUI
{
    public class Matrix4x4GUI : ValueGUI<Matrix4x4>
    {
        ...
        public override Matrix4x4 Show()
        {
            ...
            base.Value = new Matrix4x4
            (new Vector4(this.floatGUIM00.Value, this.floatGUIM01.Value, this.floatGUIM02.Value, this.floatGUIM03.Value),
             new Vector4(this.floatGUIM10.Value, this.floatGUIM11.Value, this.floatGUIM12.Value, this.floatGUIM13.Value),
             new Vector4(this.floatGUIM20.Value, this.floatGUIM21.Value, this.floatGUIM22.Value, this.floatGUIM23.Value),
             new Vector4(this.floatGUIM30.Value, this.floatGUIM31.Value, this.floatGUIM32.Value, this.floatGUIM33.Value));
